...
class BaseLookupMethod extends React.Component {
  getCoursesByQuery(query) {
    return fetch(Constants.SERVER_URL + "q?" + query + "&Semester=Fall&Year=2018&limit=1000")
  ...
  getCourseByID(courseID) {
    ...
    const query = `Department=${department}&CrseNum=${courseNum}&Semester=Fall&Year=2018&limit=100`;
